...
export const tutorials: Tutorial[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1577720643272-265e434f0f9f?w=400&h=300&fit=crop',
    category: 'hands',
    type: 'step-by-step',
    difficulty: 'beginner',
    steps: [
      {
        id: 'gesture-1',
        image: 'https://images.unsplash.com/photo-1588882657179-d4d5a0b60e09?w=800&h=600&fit=crop',
      ...
      {
        id: 'gesture-2',
        image: 'https://images.unsplash.com/photo-1562070555-61d397763a46?w=800&h=600&fit=crop',
      ...
      {
        id: 'gesture-3',
        image: 'https://images.unsplash.com/photo-1578667150363-4dc5d752b0c5?w=800&h=600&fit=crop',
      ...
      {
        id: 'gesture-4',
        image: 'https://images.unsplash.com/photo-1577720643272-265e434f0f9f?w=800&h=600&fit=crop',
  ...
  // ANATOMÍA
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1578321272176-b7bfd2d0adc4?w=400&h=300&fit=crop',
    category: 'anatomy',
    type: 'step-by-step',
    difficulty: 'intermediate',
    steps: [
  ...
  // ROSTROS
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1578692408949-64b61cb29e80?w=400&h=300&fit=crop',
    category: 'faces',
    type: 'step-by-step',
    difficulty: 'beginner',
    steps: [
      {
        id: 'face-1',
        image: 'https://images.unsplash.com/photo-1578692408949-64b61cb29e80?w=800&h=600&fit=crop',
        description: 'Paso 1: Dibuja un círculo para el cráneo',
        tips: ['El rostro mide 1.5 veces el ancho de la cabeza']
      },
      {
        id: 'face-2',
        image: 'https://images.unsplash.com/photo-1578642181284-1dba84a0acfc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1578821154957-4f9e4d3a6b0b?w=400&h=300&fit=crop',
    category: 'faces',
    type: 'step-by-step',
    difficulty: 'intermediate',
    steps: [
      {
        id: 'expr-1',
        image: 'https://images.unsplash.com/photo-1578821154957-4f9e4d3a6b0b?w=800&h=600&fit=crop',
        description: 'Felicidad: Levanta las comisuras de los labios y los músculos alrededor de los ojos',
        tips: ['Las arrugas alrededor de los ojos crean líneas de sonrisa', 'Los pómulos se levantan']
      },
      {
        id: 'expr-2',
        image: 'https://images.unsplash.com/photo-1578642181284-1dba84a0acfc?w=800&h=600&fit=crop',
        description: 'Tristeza: Baja las comisuras de los labios y levanta las cejas interiores',
    ...
    steps: [
      {
        id: 'pose-1',
        image: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=600&fit=crop',
        description: 'Paso 1: Línea de acción - Una línea que muestre el flujo del movimiento',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1567721913486-6585dfe1feed?w=400&h=300&fit=crop',
    category: 'poses',
    type: 'timelapse',
    difficulty: 'beginner',
    timelapseUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
  ...
  // CABELLO
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1560807707-38cc5baea42d?w=400&h=300&fit=crop',
    category: 'hair',
    type: 'step-by-step',
    difficulty: 'intermediate',
    steps: [
      {
        id: 'hair-1',
        image: 'https://images.unsplash.com/photo-1560807707-38cc5baea42d?w=800&h=600&fit=crop',
